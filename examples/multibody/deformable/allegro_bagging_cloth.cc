...
int do_main() {
  ...
  AddCloth(&deformable_model, 30 * 2, 0.4, 0, 0, 0.007);
  AddCloth(&deformable_model, 50, 30, 0.31, 0.4, -0.4 + 0.08, 0.007);

  MpmConfigParams mpm_config;
  mpm_config.domain_bits = 8;
  mpm_config.grid_block_spacing = 2.0;

  mpm_config.youngs_modules = 300000.0;
  mpm_config.density = 1500.0;
  mpm_config.cloth_K = 1e5;
  mpm_config.rpic_damping = 0.2;
  mpm_config.sdf_friction = 1.0;
